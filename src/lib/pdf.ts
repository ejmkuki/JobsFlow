...
// (Word/Docs/Chrome "export to PDF" with standard single-byte text
// encoding) and honestly returns null — never garbled mojibake — when it
// can't confidently read a file (encrypted PDFs, or ones using embedded
// CID/Identity-H fonts that need a ToUnicode CMap we don't parse).
