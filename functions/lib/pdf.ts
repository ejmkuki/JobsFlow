...
// to PDF", including embedded CID/Identity-H subset fonts via their
// /ToUnicode CMap) and honestly returns null — never garbled mojibake —
// when it can't confidently read a file (encrypted PDFs, or CID fonts with
// no embedded ToUnicode map to decode against).
